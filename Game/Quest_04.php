...
<body>
	<main>
		<section class="container wrapper">
			...
			<br/><h3 style="text-align: center;" class="display-5"><strong> <?php echo $_SESSION["quest_4"][1];?> </strong></h3>
			...
			<form method="post">
				...
				<?php
					...
					if (array_key_exists('elimina', $_POST)) {
						...
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_4"][2].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_4"][3].'" /> <br/></div>');
						...
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_4"][3].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_4"][4].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_4"][5].'" /> <br/></div>');
					...
					echo "<br/><br/>";
					echo '<input type="submit" name='.$_SESSION["quest_4"][0].' class="btn btn-block btn btn-outline-danger" value="Denunciar">';
