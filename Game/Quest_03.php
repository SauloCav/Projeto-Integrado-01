	...
	<main>
		<section class="container wrapper">
			<div class="page-header">
				<h1 class="display-5">Pergunta 03</h1>
			</div>
			...
			<?php
				if ($_SERVER['REQUEST_METHOD'] === 'POST') {
					...
					if ($_SESSION["value"] === 'Denunciar') {
						$_SESSION["denounces_from_where"] = 3;
			...
			<br/><h3 style="text-align: center;" class="display-5"><strong> <?php echo $_SESSION["quest_3"][1];?> </strong></h3>
			...
			<form method="post">
				...
				<?php
					...
					if (array_key_exists('elimina', $_POST)) {
						...
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_3"][2].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_3"][3].'" /> <br/></div>');
						...
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_3"][3].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_3"][4].'" /> <br/></div>',
						'<div id="divFirst"><input type="submit" name="buttom" 
						class="btn btn-block btn btn-outline-primary" value= "'.$_SESSION["quest_3"][5].'" /> <br/></div>');
					...
					echo "<br/><br/>";
					echo '<input type="submit" name='.$_SESSION["quest_3"][0].' class="btn btn-block btn btn-outline-danger" value="Denunciar">';
			...
			<div id="prize">
			<h3><br> Acertar: R$ 50 Mil || Parar: R$ 5 Mil || Errar: R$ 2.5 Mil</h3>
			</div>
