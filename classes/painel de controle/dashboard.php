    ...
    <nav class="navbar navbar-default title1">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="Javascript:void(0)"><b>Show Do Milhão</b></a>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php
                    ...
                    {
                        echo '<div class="row"><span class="title1" style="margin-left:40%;font-size:30px;color:#fff;"><b>Detalhes do Quiz</b></span><br /><br />
                        ...
                        <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="name" name="name" placeholder="Titulo do Quiz" class="form-control input-md" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="total" name="total" placeholder="Número total de questões" class="form-control input-md" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="right" name="right" placeholder="Selecione a resposta correta" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="wrong" name="wrong" placeholder="Selecione a resposta errada" class="form-control input-md" min="0" type="number">
                                    </div>
                                </div>
                ...
                <?php
                    if(@$_GET['q']==4 && (@$_GET['step'])==2 ) 
                    {
                        echo ' 
                        <div class="row">
                        <span class="title1" style="margin-left:40%;font-size:30px;"><b>Detalhes da resposta</b></span><br /><br />
                        ...
                        for($i=1;$i<=@$_GET['n'];$i++)
                        {
                            echo '<b>Question number&nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="3" cols="5" name="qns'.$i.'" class="form-control" placeholder="Escreva o número da pergunta '.$i.' here..."></textarea>  
                                        </div>
                                    </div>
                                    <div class="form-group">
